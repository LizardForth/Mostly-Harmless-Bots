...
void on_message(struct discord *client, const struct discord_message *msg) {
  ...
  if (strlen(msg->content) > 10002) {
    struct discord_create_message say = {
        .content =
            "WARNING: I will not parse code larger than 10000 charcters!"};
    ...
    if (ends_in_string(msg->content, "!FTH") ||
      ...
      char *command =
          malloc((strlen(msg->content) * sizeof(char)) + (9 * sizeof(char)));
      ...
      char *command_old =
          malloc((strlen(command) * sizeof(char)) + (sizeof(char) * 9));
      char *forth_in =
          malloc((strlen(command) * sizeof(char)) + (sizeof(char) * 9));
      ...
      if (pfx == 2) {
        ...
        case -260:
          discord_embed_add_field(
              ...
              "Your code has encountered an error check output for info.",
              false);
          ...
          if (strstr(buffer, "not found")) {
            ...
            discord_embed_add_field(
                ...
                "One of your words drew too much data from the data stack",
                false);
            discord_embed_add_field(
                &debug_embed, "Proposed Solutions:",
        ...
        case -261:
          discord_embed_add_field(&embed, "Error Explanation:",
                                  "Your code reached a debugger breakpoint.",
                                  false);
          break;
        case -1:
          discord_embed_add_field(&embed, "Error Explanation",
