...
**
**************************************************************************/
char *ficlStringReverse(char *string) { /* reverse a string in-place */
  int i = strlen(string);
...
**
**************************************************************************/
char *ficlLtoa(ficlInteger value, char *string,
               int radix) { /* convert long to string, any base */
  char *cp = string;
...
**
**************************************************************************/
char *ficlUltoa(ficlUnsigned value, char *string,
                int radix) { /* convert long to string, any base */
  char *cp = string;
  ficl2Unsigned ud;
  ficl2UnsignedQR result;
...
void ficlCompatibilityTextOutCallback(
    ficlCallback *callback, char *text,
